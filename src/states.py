...
reserved_symbols_machine = StateMachine(
    ...
    final={
        ...
        186: FinalState(TokenType.MULTIPLY_ASSIGN),
        188: FinalState(TokenType.POWER),
        190: FinalState(TokenType.POWER_ASSIGN),
        192: FinalState(TokenType.PLUS),
        194: FinalState(TokenType.PLUS_ASSIGN),
        196: FinalState(TokenType.MINUS),
        198: FinalState(TokenType.MINUS_ASSIGN),
        200: FinalState(TokenType.DIVIDE),
        202: FinalState(TokenType.DIVIDE_ASSIGN),
        204: FinalState(TokenType.FLOOR),
        206: FinalState(TokenType.FLOOR_ASSIGN),
        208: FinalState(TokenType.MODULO),
        210: FinalState(TokenType.MODULO_ASSIGN),
