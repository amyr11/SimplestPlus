...
reserved_symbols_machine = StateMachine(
    ...
    initial=0,
    final={
        205: FinalState(TokenType.SPACE, retract=False),
        206: FinalState(TokenType.SPACE, retract=False),
        207: FinalState(TokenType.SPACE, retract=False),
        208: FinalState(TokenType.INDENT, retract=False),
